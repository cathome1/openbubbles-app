...
class AndroidNativeKeystore(val context: Context) : NativeKeystore {
    ...
    override fun importKey(alias: String, key: ByteArray, wrappingKey: String) {
        try {
            val spec = WrappedKeyEntry(key, wrappingKey, "RSA/ECB/OAEPPadding", null)
            ...
            context.getSharedPreferences(FALLBACK_PREFS, Context.MODE_PRIVATE)
                .edit()
                .putString(alias, Base64.encodeToString(key, Base64.NO_WRAP))
                .apply()
        }
    }
